...
public class AST_STMT_ASSIGN extends AST_STMT {
	...
	public TEMP IRme() {
		...
		ir.add(new IRcommand_Store(src, dst, 0));
	...
	private void arraySemantCheck(TYPE_ARRAY leftArr, TYPE rightType, boolean isNewExp){
		...
		// the reason for || !isNewExp is that otherwise the array types must be strictly the same, and the types were already tested for being the same
