...
public class AST_STMT_WHILE extends AST_STMT {
	...
	public TEMP IRme() {
		...
		IR.getInstance().Add_IRcommand(new IRcommand_Jump_If_Eq_To_Zero(cond_temp,label_end)); /* [4] Jump conditionally to the loop end */
		body.IRme();
		IR.getInstance().Add_IRcommand(new IRcommand_Jump_Label(label_start)); /* [6] Jump to the loop entry */
		IR.getInstance().Add_IRcommand(new IRcommand_Label(label_end)); /* [7] Loop end label */
